...
app.get('/newnote', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var n, stringed, note;
    return __generator(this, function (_a) {
        n = req.headers.body;
        stringed = "".concat(n);
        note = JSON.parse(stringed);
        knex('notes')
            .insert({
            id: note.id,
            title: note.title,
...
app.get('/deletenote', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var n, stringed, note;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
